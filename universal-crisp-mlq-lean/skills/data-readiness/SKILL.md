...
For lean prototyping, prioritize checks that prevent leakage and major data quality failures.
...
- Mark low-coverage zones as risks instead of blocking progress by default.
...
Lean note:
- If verdict is Conditional, proceed with explicit risk notes and a targeted cleanup backlog.
